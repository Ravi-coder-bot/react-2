...
const Footer = () => {
  ...
  return (
    <div className='footer'>
        ...
        <div className='footer-logo'>Nidar Nari</div>
        <p className='para'>Nidar-Nari is an innovative app that uses cutting-edge technology</p>
        <p className='para'>to ensure the safety of people at all times.</p>
